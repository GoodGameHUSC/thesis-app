...
import Stars from '../UIElement/Stars';
import { useNavigation } from '@react-navigation/native';
import { TouchableArea } from 'App/Screens/Component/UIElement';
export default class ListProductManage extends React.Component {
  constructor(props) {
    super(props)
  }
        ...
        <>
          ...
          <View style={{ width: '50%' }}>
            <View style={{ backgroundColor: 'white', width: '100%', padding: 10, paddingVertical: 10 }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'flex-end', marginTop: 40 }}>
