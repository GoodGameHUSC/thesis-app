...
export default function SubmitRateScreen({ }) {
  ...
  const method = {
    submitReview: () => {
      ...
      if (content.split('').length <= 10 || content.split('').length > 2000) { Toast.show("Nội dung đánh giá nên có độ dài từ 50 đến 2000 ký tự"); return; }
  ...
  return (<ScrollView>
    <View style={{ backgroundColor: Colors.white, padding: 10, minHeight: ScreenHeight }}>
      ...
      <View style={{ alignItems: 'center', marginTop: 20 }}>
        ...
        <StarRating
          fullStarColor={Colors.yellowTint}
